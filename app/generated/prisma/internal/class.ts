...
/**
  ...
  /**
   * `prisma.recoverPassword`: Exposes CRUD operations for the **RecoverPassword** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more RecoverPasswords
    * const recoverPasswords = await prisma.recoverPassword.findMany()
    * ```
    */
  get recoverPassword(): Prisma.RecoverPasswordDelegate<ExtArgs, { omit: OmitOpts }>;
}
